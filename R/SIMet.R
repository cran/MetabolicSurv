...
#'
#' The Function fits cox proportional hazard model and does classification
...
#' This function internally calls \code{\link[MetabolicSurv]{MSpecificCoxPh}}
...
#' @param TopK 	Top K metabolites (15 by default) to be used in the sequential
#' analysis.
...
#' @param Select Number of metabolites to be selected from supervised PCA.
#' This is valid only if the argument Reduce=TRUE
#' @param Prognostic A dataframe containing possible prognostic(s) factor
#' and/or treatment effect to be used in the model.
#' @param Plot A boolean parameter indicating if Plot should be shown.
#' Default is FALSE
...
#' @return A list containing a data frame with estimated HR along with 95% CI
#' at each TopK value for the sequential analysis.
#'   \item{Result}{The hazard ratio statistics (HR, Lower confidence interval
#'   and upper confidence interval) of the lower riskgroup based for each
#'   sequential metabolite analysis}
#'   \item{TopKplot}{A graphical representation of the Result containing the
